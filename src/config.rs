...
pub struct SecretContainer(orbit_masking::Secret<String>);
...
impl SecretContainer {
    ...
    pub async fn expose(&self, config: &Config) -> orbit_masking::Secret<String> {
        if cfg!(feature = "aws") {
            use base64::Engine;
            ...
            orbit_masking::Secret::new(secret)
...
pub struct Database {
    pub port: u16,
    pub host: String,
    pub user: orbit_masking::Secret<String>,
    pub password: SecretContainer,
    pub dbname: orbit_masking::Secret<String>,
