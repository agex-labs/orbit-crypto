...
use orbit_masking::PeekInterface;
...
pub struct DecryptedData(orbit_masking::StrongSecret<Vec<u8>>);

impl DecryptedData {
    pub fn from_data(data: orbit_masking::StrongSecret<Vec<u8>>) -> Self {
        Self(data)
    }

    pub fn inner(self) -> orbit_masking::StrongSecret<Vec<u8>> {
        self.0
    }
}
...
pub struct EncryptedData {
    pub version: Version,
    pub data: orbit_masking::StrongSecret<Vec<u8>>,
}
        ...
        impl Visitor<'_> for EncryptedDataVisitor {
                ...
                E: de::Error,
            {
                ...
                Ok(EncryptedData {
                    ...
                    data: orbit_masking::StrongSecret::new(dec_data),
                })
            }
        }
...
mod tests {
    ...
    fn test_data_deserialize() {
        ...
        let expected_data = EncryptedData {
            ...
            data: orbit_masking::StrongSecret::new(
